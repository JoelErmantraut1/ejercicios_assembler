...
;Dado PIC 16F84, leds, llaves, cristal de 4 MHz, capacitores y demás componentes necesarios; y utilizando como salida 3 leds que prendan
;con "1", armar un programa que respete el siguiente un diagrama de tiempos.
;
;-----------------------------------------------------------------------------------------------------------------------------------
...
; SE ESTABILICE EL OSCILADOR INTERN2O, CUANDO PASA A 1 ARRANCA LA INICIALIZACION
	...
	banksel		TRISA
	movlw		b'00000001'
	movwf		TRISA			;Pulsador en RA0.

	movlw		b'00000000'
	movwf		TRISB			;Todas salidas.
