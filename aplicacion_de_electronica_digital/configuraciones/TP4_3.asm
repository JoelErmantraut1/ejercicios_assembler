;RB0...hasta RB6 salidas y RB7 entrada.
;RA0, RA1 y RA2 entrada. RA3 y RA4 salidas.
;Preescaler asignado a WDT. Relacion 1:32
;Interrupcion por d')fin de escritura de EEPROM
;					d'') Interrupcion por RB7
;-----------------------------------------------------------------------------------------------------------------------------------
...
; SE ESTABILICE EL OSCILADOR INTERN2O, CUANDO PASA A 1 ARRANCA LA INICIALIZACION
	...
	banksel		TRISA
	movlw		b'00000111'
	movwf		TRISA			;RA0, RA1, RA2: Entradas - RA3 y RA4 salidas.

	movlw		b'10000000'
	movwf		TRISB			;RB0-6: salidas - RB7: entrada

	banksel		OPTION_REG
	movlw		b'10001101'
	movwf		OPTION_REG		;RB3: Preescaler asignado a WDT
								;RB2-0: Relacion preescaler 1:32(WDT)

	BSF			OPTION_REG,PSA	;Preescaler asignado a WDT
	BSF			OPTION_REG,0	;Relacion preescaler 1:32(WDT)
	BCF			OPTION_REG,1	;Relacion preescaler 1:32(WDT)
	BSF			OPTION_REG,2	;Relacion preescaler 1:32(WDT)
